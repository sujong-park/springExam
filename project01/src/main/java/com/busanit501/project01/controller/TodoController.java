package com.busanit501.project01.controller;
...
import com.busanit501.project01.service.TodoService;
...
//            redirectAttributes.addAttribute("size",pageRequestDTO.getSize());
    ...
    public String updateLogic(@Valid TodoDTO todoDTO, BindingResult bindingResult,
                              ...
                              RedirectAttributes redirectAttributes) {
        log.info("todoDTO확인 finished의 변환 여부 확인1. : " + todoDTO);
        ...
        log.info("todoDTO확인 finished의 변환 여부 확인2. : " + todoDTO);
