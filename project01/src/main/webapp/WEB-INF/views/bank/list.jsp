        ...
        <div class="row">
            <div class="col">
                <nav class="navbar navbar-expand-lg bg-body-tertiary">
                    <div class="container-fluid">
                        <a class="navbar-brand" href="/bank/list">목록가기</a>
            ...
            <div class="col">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <%--                        검색 입력창, 검색 조건, 필터 조건                        --%>
                        <form action="/bank/list" method="get">
                        ...
                        <table class="table">
                            ...
                            <c:forEach items="${pageResponseDTO.dtoList}" var="dto">
                                <tr>
                                    ...
                                    <td><a href="/bank/read?tno=${dto.tno}&${pageRequestDTO.link}"
...
// 글쓰기 폼으로 가야함.
    ...
    document.querySelector(".pagination").addEventListener("click",
        function (e) {
            ...
            // 백틱, 숫자 키보드 1번 왼쪽에 보면.
            //  기존 페이지 이동해서,
            // self.location = `/bank/list?page=\${num}`
            // 폼의 정보를 이용해서 이동.
