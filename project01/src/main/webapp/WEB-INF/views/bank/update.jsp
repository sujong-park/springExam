...
<script>
    ...
    document.querySelector(".btn-primary").addEventListener("click",
        function (e) {
            ...
            self.location = "/bank/update?tno=" +${todoDTO.tno}
                , false
        })
    // 목록
    document.querySelector(".btn-secondary").addEventListener("click",
        function (e) {
            // 수정폼으로 가야함. 그러면, 필요한 준비물 tno 번호가 필요함
            self.location = "/bank/list?${pageRequestDTO.link}"
                , false
        })
    ...
    document.querySelector(".btn-danger").addEventListener("click",
        function (e) {
            ...
            // formObj , 원래 action: /bank/update
            // 속성을 변경 가능해서, 임시로, 삭제 url 변경.
            // 삭제 후에도, 검색 내역을 유지하기.
            formObj.action = "/bank/delete?${pageRequestDTO.link}"
            formObj.method = "post"
    ...
    document.querySelector(".btn-primary").addEventListener("click",
        function (e) {
            ...
            formObj.action = "/bank/update?${pageRequestDTO.link}"
            formObj.method = "post"
            // todoDTO 모든 멤버가 같이 전달됨.
            // tno, title, dueDate, finished, writer
            formObj.submit()
